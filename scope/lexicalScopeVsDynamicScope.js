...
function dynamicScopeExample() {
    let dynamicVariable = "I am a dynamic variable";
    function innerFunction() {
        console.log(dynamicVariable); // This will work because innerFunction is called after dynamicVariable is defined
    } 
    innerFunction();
}
dynamicScopeExample();
